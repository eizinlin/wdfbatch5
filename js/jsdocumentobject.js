...
// document.getElementById("tasktitle").textContent = `<span style="color:yellow"> My Jobs</span>`;
...
chl = getul.children; //HTML Colloection
console.log(chl);
console.log(chl[0]);
...
// getul.children[1].innerHTML = `Have to read <a href="#" id="delete-item1" class="delete-item delete-me"><i class="fa-solid fa-trash-can"></i></a>`
...
// console.log(sbl);
            ...
            // list-item 1     list-item 2     list-item 3         list-item 2         list-item 1
...
// newli.innerText = "hi";
// newli.innerHTML = `List Item 6<a href="#" id="delete-item"><i class="fa-solid fa-trash-can"></i></a> `;
...
// addEventLinstener(eventtype,callbackfunction)
